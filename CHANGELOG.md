...
Packages with other changes:
 ...
 - [`flutter_onscreen_keyboard` - `v0.4.4`](#flutter_onscreen_keyboard---v044)

---

#### `flutter_onscreen_keyboard` - `v0.4.4`
...
Packages with other changes:
 ...
 - [`example` - `v0.2.0+1`](#example---v0201)
 - [`flutter_onscreen_keyboard` - `v0.4.2+1`](#flutter_onscreen_keyboard---v0421)
...
#### `flutter_onscreen_keyboard` - `v0.4.2+1`
...
Packages with breaking changes:
 ...
 - [`example` - `v0.2.0`](#example---v020)

Packages with other changes:

 - [`flutter_onscreen_keyboard` - `v0.4.2`](#flutter_onscreen_keyboard---v042)
...
#### `example` - `v0.2.0`
 ...
 - **FEAT**: add predefined themes (Gboard, iOS) for easy styling ([#18](https://github.com/albinpk/flutter_onscreen_keyboard/issues/18)). ([e4958c39](https://github.com/albinpk/flutter_onscreen_keyboard/commit/e4958c394569d6adad246706e4cb9c2911fd61ef))
...
#### `flutter_onscreen_keyboard` - `v0.4.2`
...
Packages with other changes:
 ...
 - [`flutter_onscreen_keyboard` - `v0.4.1`](#flutter_onscreen_keyboard---v041)

---

#### `flutter_onscreen_keyboard` - `v0.4.1`
...
Packages with breaking changes:
 ...
 - [`flutter_onscreen_keyboard` - `v0.3.0`](#flutter_onscreen_keyboard---v030)
...
#### `flutter_onscreen_keyboard` - `v0.3.0`
